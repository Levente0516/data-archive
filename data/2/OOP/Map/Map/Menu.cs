    ...
    public class Menu
    {
            ...
            do
            {
                ...
                switch (v)
                {
                    ...
                    case 5:
                        ...
                        {
                            Console.WriteLine($"map does not contains an element with the key {key} ");
                        }
                        break;
                    case 6:
                        Console.Write("key: ");
                        ...
                        try
                        {
                            ...
                            Console.WriteLine("[indexerrel]: " + map[key]);
                        }
        ...
        private static int GetMenuPoint()
        {
            ...
            do
            {
                ...
                Console.WriteLine("1. Kiürit");
                Console.WriteLine("2. Elemek szama");
                Console.WriteLine("3. Beszur");
